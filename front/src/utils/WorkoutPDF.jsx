...
const TRANSLATIONS = {
    ...
    ar: {
        ...
        equipment: 'المعدات',
        notes: 'ملاحظات',
        generatedBy: 'تم الإنشاء بواسطة TFG',
        kg: 'كجم',
        sessionNumber: 'جلسة رقم',
...
export async function generateWorkoutPDF({
    ...
    const infoCards = [
        { label: t.client, value: clientName, icon: '👤' },
        { label: t.trainer, value: trainerName, icon: '💪' },
        { label: t.date, value: date, icon: '📅' }
    ];
