...
// ─── Skeleton Card ──────────────────────────────────────────────────────────
const SkeletonCard = () => (
    <div className="bg-zinc-50 dark:bg-[#121214] border border-zinc-200 dark:border-zinc-800/80 rounded-[2rem] p-6 animate-pulse">
        ...
        <div className="mt-6 pt-4 border-t border-zinc-200 dark:border-zinc-800/50 flex justify-between">
...
const ChildrenProfiles = () => {
    ...
    const fetchChildren = useCallback(async (urlOverride = null) => {
        ...
        try {
            let url;
            if (urlOverride) {
                // Strip the origin, keep only path+query
    ...
    return (
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
                <div className="relative group max-w-2xl w-full flex-1">
                    ...
                    <input
                        ...
                        className="block w-full pl-12 pr-4 py-4 bg-zinc-200 dark:bg-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-2xl text-zinc-900 dark:text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"
                    />
                    {searchTerm && (
                        <button
            ...
            {loading ? (
                ...
                <div className="py-24 text-center space-y-4 bg-zinc-100 dark:bg-zinc-900/30 rounded-3xl border border-dashed border-zinc-300 dark:border-zinc-800">
                    <div className="w-20 h-20 bg-zinc-200 dark:bg-zinc-900 rounded-full flex items-center justify-center mx-auto text-zinc-400 dark:text-zinc-600">
                        <Baby size={32} />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {children.map(child => (
                            <div
                                ...
                                className="group relative bg-zinc-50 dark:bg-[#121214] border border-zinc-300 dark:border-zinc-800/80 rounded-[2rem] p-6 hover:border-blue-500/30 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-900/10 overflow-hidden"
                            >
                                ...
                                <div className="relative z-10 flex items-start gap-5">
                                    <div className="relative shrink-0">
                                        <div className="w-20 h-20 rounded-2xl bg-zinc-200 dark:bg-zinc-900 overflow-hidden border-2 border-zinc-300 dark:border-zinc-800 group-hover:border-blue-500/50 transition-colors shadow-lg">
                                            {child.photo_url ? (
                                                ...
                                                <div className="w-full h-full flex items-center justify-center text-zinc-500 dark:text-zinc-600 bg-zinc-200 dark:bg-zinc-800">
                                                    <User size={28} />
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    <div className="flex-1 min-w-0 space-y-1 pt-1">
                                        <h3 className="text-xl font-bold text-zinc-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors truncate">
                                            {child.name}
                                        </h3>
                                        <div className="flex items-center gap-2 flex-wrap">
                                            <span className="bg-zinc-200 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 text-xs font-mono px-2 py-1 rounded-lg border border-zinc-300 dark:border-zinc-800 flex items-center gap-1">
                                                <Hash size={10} /> {child.manual_id}
                                            </span>
                                            {child.age && (
                                                <span className="bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold px-2 py-1 rounded-lg border border-blue-500/20">
                                                    {child.age} yrs
                                                </span>
                                            )}
                                        </div>
                                    ...
                                    <div className="flex items-center justify-center shrink-0">
                                        <div className="w-10 h-10 rounded-full bg-zinc-200 dark:bg-zinc-900 flex items-center justify-center text-zinc-400 dark:text-zinc-500 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                                            <ArrowRight size={18} />
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-6 pt-4 border-t border-zinc-200 dark:border-zinc-800/50 flex items-center justify-between text-xs font-medium text-zinc-500">
                                    ...
                                    <span className={child.is_subscribed ? 'text-green-600 dark:text-green-500' : 'text-zinc-500 dark:text-zinc-600'}>
            ...
            {isModalOpen && (
                <div
                    className="fixed inset-0 bg-black/50 dark:bg-black/80 backdrop-blur-md z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200"
                ...
                >
                    <div className="bg-zinc-50 dark:bg-[#121214] border border-zinc-300 dark:border-zinc-800 w-full max-w-md rounded-3xl p-8 shadow-2xl animate-in zoom-in-95 duration-200 relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="absolute top-5 right-5 p-2 bg-zinc-200 dark:bg-zinc-800 rounded-full text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors z-10"
                        >
                            <X size={16} />
                        </button>
                        ...
                        <form onSubmit={handleAddChild} className="space-y-5" noValidate>
                            {/* Name */}
                            <div>
                                <label className="text-xs font-bold text-zinc-500 uppercase ml-1 mb-1.5 block">Full Name</label>
                                <input
                                    className={`w-full bg-zinc-200 dark:bg-zinc-950 border rounded-xl px-4 py-3.5 text-zinc-900 dark:text-white outline-none focus:border-blue-500 transition-all ${formErrors.name ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-800'}`}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        className={`w-full bg-zinc-200 dark:bg-zinc-950 border rounded-xl px-4 py-3.5 text-zinc-900 dark:text-white outline-none focus:border-blue-500 transition-all font-mono ${formErrors.manual_id ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-800'}`}
                                        placeholder="1024"
                                ...
                                <div>
                                    ...
                                    <input
                                        className={`w-full bg-zinc-200 dark:bg-zinc-950 border rounded-xl px-4 py-3.5 text-zinc-900 dark:text-white outline-none focus:border-blue-500 transition-all ${formErrors.phone ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-800'}`}
                                        placeholder="010..."
                            ...
                            <div>
                                ...
                                <input
                                    type="file"
                                    accept="image/*"
                                    className="w-full bg-zinc-200 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-xl px-4 py-3 text-sm text-zinc-500 dark:text-zinc-400 file:bg-zinc-300 dark:file:bg-zinc-800 file:text-zinc-700 dark:file:text-zinc-300 file:border-0 file:rounded-lg file:px-3 file:py-1.5 hover:file:bg-zinc-400 dark:hover:file:bg-zinc-700 transition-all"
                            ...
                            <div className="flex gap-3 mt-8">
                                <button
                                    type="button"
                                    onClick={handleCloseModal}
                                    className="flex-1 bg-zinc-200 dark:bg-zinc-900 hover:bg-zinc-300 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white py-3.5 rounded-xl font-bold transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-1 bg-blue-600 hover:bg-blue-500 disabled:opacity-60 disabled:cursor-not-allowed text-white py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-900/20 active:scale-95 flex items-center justify-center gap-2"
                                >
                                    {isSubmitting ? (
