                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p className="text-zinc-500 mt-1">
                            Welcome back, <span className="text-orange-600 dark:text-orange-500 font-bold">{user?.username}</span>
                        </p>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-zinc-50 dark:bg-[#121214] border border-zinc-300 dark:border-zinc-800 p-6 rounded-3xl relative overflow-hidden group hover:border-zinc-400 dark:hover:border-zinc-700 transition-colors shadow-sm">
                                ...
                                <div className="text-4xl font-black mt-1 text-zinc-900 dark:text-white">
                                    {data.financials.total_sales || 0} <span className="text-lg text-zinc-400 dark:text-zinc-600 font-bold">Pkgs</span>
                                </div>
                            </div>
