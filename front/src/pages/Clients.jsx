...
const Clients = () => {
    // ... [نفس المتغيرات والدوال السابقة بدون تغيير] ...
    // ... (Keep existing useState, useEffects, and handlers) ...
    ...
    useEffect(() => {
        const delayDebounceFn = setTimeout(() => { fetchClients(null, searchQuery); }, 500);
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="flex justify-center items-center gap-4 mt-12 mb-4">
                        <button onClick={() => fetchClients(prevPage)} disabled={!prevPage} className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm">
                            <ChevronLeft size={18} /> Previous
                        </button>
                        <button onClick={() => fetchClients(nextPage)} disabled={!nextPage} className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm">
